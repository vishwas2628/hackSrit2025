...
const CareerForm = () => {
  ...
  useEffect(() => {
    if (formData.careerField) {
      const selectedField = CAREER_FIELDS.find(
        (field) => field.id === formData.careerField
      );
      if (selectedField) {
  ...
  const renderSkillsStep = () => (
    <div className="mb-6">
      ...
      <p className="text-blue-200 mb-4">
        Select the skills you possess in{" "}
  ...
  const renderInterestsStep = () => (
    <div className="mb-6">
      ...
      <p className="text-blue-200 mb-4">
        Select areas that interest you (even if they're outside your current
        field):
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
      ...
      <div className="bg-blue-900/30 rounded-lg p-4 mb-4">
        ...
        <div className="flex flex-wrap gap-2 mt-2">
          {formData.skills.map((skill) => (
            <span
              key={skill}
              className="bg-blue-800/60 text-blue-200 px-2 py-1 rounded text-sm"
            >
              {skill}
            </span>
          ))}
        ...
        {!formSubmitted ? (
          <>
            ...
            <p className="text-blue-200 text-center mb-8">
              Answer a few questions about your skills, interests, and goals to
            ...
            <form
              ...
              className="bg-blue-900/20 p-6 rounded-lg border border-blue-800 shadow-lg"
            >
              {renderStepContent()}
